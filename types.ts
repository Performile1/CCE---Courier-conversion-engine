...
export interface CarrierSettings {
  ...
  networkCoverageSourceUrl?: string;
  networkCoverageSourceLabel?: string;
  networkCoverageCapturedAt?: string;
  networkCoverageConfidence?: 'verified' | 'estimated' | 'missing';
  networkCoverageSnippet?: string;
