...
function normalizePersistedLead(row: PersistedLeadRow): LeadData {
  ...
  return {
    ...
    annualPackageEstimateSource: payload.annualPackageEstimateSource,
    pos1Volume: payload.pos1Volume,
    pos2Volume: payload.pos2Volume,
    estimatedAOV: payload.estimatedAOV,
    pricingProductName: payload.pricingProductName,
    pricingProductSource: payload.pricingProductSource,
