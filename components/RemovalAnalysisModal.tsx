        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <button 
              ...
              className="w-full flex items-center gap-3 p-4 bg-slate-50 border border-slate-200 text-left hover:bg-red-50 hover:border-red-300 transition-colors shadow-sm rounded-sm"
            >
              <Copy className="w-5 h-5 text-red-600" />
              <div>
                <span className="block text-sm font-bold text-slate-800">Duplikat / Flera träffar</span>
            ...
            >
              ...
              <div>
                <span className="block text-sm font-bold text-slate-800">Befintlig kund</span>
            ...
            >
              ...
              <div>
                <span className="block text-sm font-bold text-slate-800">Redan bearbetad / Nedladdad</span>
            ...
            >
              ...
              <div>
                <span className="block text-sm font-bold text-slate-800">Inte relevant (fel bransch/segment)</span>
            ...
            >
              ...
              <div>
                <span className="block text-sm font-bold text-slate-800">Felaktig data (AI-hallucination)</span>
